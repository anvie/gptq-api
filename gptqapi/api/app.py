...
from gptqapi.extras.misc import torch_gc
from gptqapi.chat import ChatModel
from gptqapi.api.protocol import (
    Role,
    Finish,
    ModelCard,
    ModelList,
...
def create_app(chat_model: ChatModel) -> FastAPI:
    ...
    async def create_chat_completion(req: Request, request: ChatCompletionRequest):
        ...
        if request.stream:
            generate = predict(query, history, system, request, req)
    ...
    async def predict(query: str, history: List[Tuple[str, str]], system: str, request: ChatCompletionRequest, req: Request):
